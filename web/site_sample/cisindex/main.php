...
<table width="500">
 ...
 <tr>
    ...
    <td><p><?php if(false){?><a href="<?php echo $newsdata[$j][url]; ?>" target=_blank><?php }?><font color="#000066" size="2"><?php echo $newsdata[$j][title]; ?></font><?php if($newsdata[$j][url] != "null"){ echo "</a>"; }?></p>
    </td>
  ...
  <table width="99%" height="100%" cellpadding="0" cellspacing="0">
    <tr> 
      <td align="right" valign="middle" class="font1"><font color="#666666">BestView IE6.0 1024x768 Copyright (c) 2007 National Hualien University of Education All Rights 
        Reserved.<br>
        網頁維護者：<a href="mailto:95h1010@stu.nhlue.edu.tw">Herb</a>、Melita、小怪</font>
	  </td>
    </tr>
  </table>
</div>
